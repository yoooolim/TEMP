...
public class Link {
    ...
    public Node isLinkNextToPoint_Node(Link _linkID){

        Node linked_point = null;
        if (this.getStartNodeID() == _linkID.getStartNodeID()) {
            linked_point = RoadNetwork.getNode(this.getStartNodeID()); //Node 반환
        }
        else if(this.getStartNodeID() == _linkID.getEndNodeID()){
            linked_point = RoadNetwork.getNode(this.getStartNodeID()); //Node 반환
            ...
            linked_point = RoadNetwork.getNode(this.getEndNodeID()); //Node 반환
